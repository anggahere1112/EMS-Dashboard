            ...
            <div class="lg:col-span-5">
                <div class="!px-12 !py-12 card-body">
                    ...
                    <div class="text-center">
                        <h4 class="mb-2 text-blue-500 dark:text-blue-500">Welcome Back !</h4>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-10" id="signInForm">
                        ...
                        <div class="mb-3">
                            ...
                            <x-input id="email" type="email" name="email" :value="old('email', 'it.sysdev@ems.com')" required autofocus
                        ...
                        <div class="mb-3">
                            ...
                            <x-input id="password" class="block mt-1 w-full" type="password" name="password" required
                                autocomplete="current-password" placeholder="Enter your password" value="qwerty123" />
